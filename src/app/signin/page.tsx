...
export default function Signin() {
    ...
    {/* 로그인 form */}
        <form className='flex flex-col gap-y-6 max-w-[400px] mx-auto'>
            <div>
                <label className='text-lg' htmlFor='email'>이메일</label>
                <input id="email"className='border-2 border-[#d9d9d9] rounded-lg h-[60px] px-4 w-[400px] mt-4' type="email" name="email" placeholder='이메일을 입력하세요.'/>
            </div>
            <div>
                <label className='text-lg ' htmlFor='password'>비밀번호</label>
                <input id="password" className='border-2 border-[#d9d9d9] rounded-lg h-[60px] px-4 w-[400px] mt-4' type="password" name="password" />
            </div>
