...
export default function FindPassword() {
    ...
    <div className='bg-[#fdfbfb] w-[520px] py-[60px]  mx-auto '>
        ...
        <form className='flex flex-col gap-y-12 max-w-[400px] mx-auto'>
            <label>
                <label className='ml-2 mb-3' htmlFor='email'>가입한 이메일 주소를 입력해 주세요.</label>
                <input type="text" id="email"  name="email" placeholder="example@hellotutor.com" className='border-2 border-[#d9d9d9] rounded-lg h-[60px] px-4 w-[400px] shadow-md'></input>
            </label>   
            <div>
