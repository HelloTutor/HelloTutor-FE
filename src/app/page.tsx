...
export default function Home() {
  ...
  const subjectArr = ['국어','영어','수학','사회','과학'];
    ...
    const settings: Settings = {
      ...
      slidesToShow: 5,
      slidesToScroll: 5,
      prevArrow:<div><ArrowLeftCircleIcon className='h-10 w-10 absolute z-10 top-[15px] left-[-25px] text-[#323232]'/></div>,
      nextArrow:<div><ArrowRightCircleIcon className='h-10 w-10 absolute z-10 top-[15px] right-[-15px] text-[#323232]'/></div>
  
    
    };
  

  return <div className=' max-w-[970px] mx-auto'>
  {/* 헤더 이미지 */}
